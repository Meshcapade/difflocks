...
class NeighborhoodSelfAttentionBlock(nn.Module):
    ...
    def forward(self, x, pos, cond):
        ...
        # Use the new NATTEN 0.21.0 API with unified na2d function
        # Reshape to heads last layout: [batch, height, width, heads, head_dim]
        ...
        x = natten.na2d(q, k, v, kernel_size=self.kernel_size, scale=1.0)
